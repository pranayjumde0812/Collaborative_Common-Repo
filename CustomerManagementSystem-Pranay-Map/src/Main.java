...
//                            customers = populatedData();
					...
					case 5:
						...
						break;
					case 6:
						Map<String, Customer> treeCust = new TreeMap<>(customers);
						customers = treeCust;
						System.out.println("Customer sorted according to email");
						break;
					case 7:
						Collection<Customer> cust = customers.values();
						ArrayList<Customer> list = new ArrayList<Customer>(cust);
						Collections.sort(list, new CustomerSortDobAndLastnameComparator());
